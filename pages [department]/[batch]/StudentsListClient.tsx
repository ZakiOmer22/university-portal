...
// // Define params as a simple object
// interface PageProps {
//     params: { department: string }; // Ensure this is just an object
// }

// export default function FacultyListPage({ params }: PageProps) {
//     const { department } = params; // Access params directly

//     // Filter faculty based on department param (case insensitive)
