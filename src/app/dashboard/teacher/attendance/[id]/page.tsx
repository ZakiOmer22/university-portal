...
export default function AttendancePage() {
    ...
    // Normalize params.id to a string (pick first if array)
    const rawCourseId = params.id;
    const initialCourseId = Array.isArray(rawCourseId)
        ? rawCourseId[0]
        : rawCourseId ?? dummyCourses[0].id;
    ...
    function saveAttendance() {
        ...
        // TODO: replace alert with API call to save on backend
    }
                                ...
                                <tbody>
                                    {paginatedStudents.map(({ id, fullName, email, phone }) => (
                                        <tr
                                            ...
                                            onClick={() =>
                                                alert(`Open student details page for ${fullName} (ID: ${id})`)
                                            }
                                        >
