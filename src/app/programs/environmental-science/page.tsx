...
import { environmentalScienceCurriculum } from "@/data/curriculums/environmental-science";
    ...
    return (
        <main className="min-h-screen bg-gradient-to-b from-green-50 via-white to-green-100">
            ...
            <section className="bg-gradient-to-r from-green-700 via-green-600 to-green-500 text-white py-16 shadow-xl">
                <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-lg text-green-200 max-w-2xl leading-relaxed">
                            A 4-year program focused on understanding and solving environmental
                            challenges through science and sustainable practices.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="max-w-6xl mx-auto px-6 py-12">
                {environmentalScienceCurriculum.map((yearData) => (
            ...
            <section className="bg-gradient-to-r from-green-50 to-green-100 py-12 mt-16">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <p className="mt-2 text-gray-600">
                        Apply now and contribute to a sustainable future.
                    </p>
                    <a
