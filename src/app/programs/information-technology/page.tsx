...
import { informationTechnologyCurriculum } from "@/data/curriculums/information-technology";
    ...
    return (
        <main className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-blue-100">
                ...
                <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-lg text-blue-100 max-w-2xl leading-relaxed">
                            A 4-year program that develops skills in networking, programming, cybersecurity,
                            and cloud computing.
                        </p>
                    </div>
                </div>
            ...
            <section className="max-w-6xl mx-auto px-6 py-12">
                {informationTechnologyCurriculum.map((yearData) => (
            ...
            <section className="bg-gradient-to-r from-blue-50 to-blue-100 py-12 mt-16">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    <h3 className="text-2xl font-bold text-gray-800">
                        Ready to start your Information Technology journey?
                    </h3>
                    <p className="mt-2 text-gray-600">
                        Apply now and become an IT expert shaping the future.
                    </p>
                    <a
