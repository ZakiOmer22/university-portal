...
import { lawCurriculum } from "@/data/curriculums/law";

export default function LawPage() {
    return (
        <main className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-gray-100">
            {/* Header */}
            <section className="bg-gradient-to-r from-blue-700 via-blue-600 to-blue-800 text-white py-16 shadow-xl">
                <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-lg text-blue-200 max-w-2xl leading-relaxed">
                            A 4-year program preparing students for the legal profession with
                            comprehensive knowledge of laws, ethics, and advocacy.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="max-w-6xl mx-auto px-6 py-12">
                {lawCurriculum.map((yearData) => (
                    <div key={yearData.year} className="mb-16">
                        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 border-b-4 border-blue-700 inline-block pb-1">
                            Year {yearData.year}
                        </h2>
            ...
            <section className="bg-gradient-to-r from-blue-50 to-blue-100 py-12 mt-16">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <p className="mt-2 text-gray-600">
                        Apply now and become a leader in justice and legal services.
                    </p>
                    <a
