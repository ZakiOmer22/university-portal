  ...
  return (
    <AuthGuard allowedRoles={["student"]}>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/20 to-indigo-50/30">
        ...
        <div className="flex min-h-screen"> {/* Added min-h-screen here */}
              ...
              <div className="mb-6 lg:mb-8">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-600 text-base lg:text-lg mt-1">Your academic command center</p>
                  </div>
                  ...
                  <div className="transform transition-all duration-300">
                    <div className="bg-white/90 backdrop-blur-sm rounded-xl lg:rounded-2xl shadow-lg lg:shadow-xl border border-white/20 p-4 lg:p-8 w-full">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 lg:mb-8">
                        <h2 className="text-xl lg:text-2xl font-bold text-gray-900 break-words">Academic Overview</h2>
